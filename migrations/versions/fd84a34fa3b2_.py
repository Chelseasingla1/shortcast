...
Revision ID: fd84a34fa3b2
Revises: 
Create Date: 2025-01-05 08:53:56.823733
...
def upgrade():
    ...
    sa.Column('roles', sa.Enum('MODERATOR', 'CONSUMERS', name='shared'), nullable=False),
