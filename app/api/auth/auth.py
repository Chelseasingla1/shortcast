...
from app.api.oauth.oauth import TwitchUserService, extract_twitch_info, GithubUserService, extract_github_info, OauthFacade
...
def login_user_():
    ...
    try:
        ...
        if client == 'twitch':
            ...
            user_id = str(extract_github_info(github_user_data, 'id'))
